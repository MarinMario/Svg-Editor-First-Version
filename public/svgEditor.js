									...
									return function (inputStrokeWidth) {
										return function (inputStrokeColor) {
											return function (mousePos) {
												return function (dragSelectedShape) {
													return {dragSelectedShape: dragSelectedShape, inputColor: inputColor, inputHeight: inputHeight, inputName: inputName, inputShapeType: inputShapeType, inputStrokeColor: inputStrokeColor, inputStrokeWidth: inputStrokeWidth, inputWidth: inputWidth, inputXPos: inputXPos, inputYPos: inputYPos, mousePos: mousePos, selectedShape: selectedShape, svgShapes: svgShapes};
												};
											};
										};
									};
...
var $author$project$HelperFunctions$getSelectedShape = F2(
		...
		switch (msg.$) {
			...
			case 'InputYPos':
				...
				return _Utils_update(
					...
					{inputYPos: yPos});
			case 'InputWidth':
				var inputWidth = msg.a;
				return _Utils_update(
					model,
					{inputWidth: inputWidth});
			case 'InputHeight':
				var inputHeight = msg.a;
				return _Utils_update(
					model,
			...
			case 'RemoveShape':
				var removedShapes = A2(
					$elm$core$List$filter,
					function (shape) {
						return !_Utils_eq(shape.id, model.selectedShape);
					},
					model.svgShapes);
				return _Utils_update(
					model,
			...
			case 'MouseMove':
				...
				return _Utils_update(
					model,
					{
						inputXPos: model.dragSelectedShape ? $elm$core$String$fromFloat(model.mousePos.a) : model.inputXPos,
						inputYPos: model.dragSelectedShape ? $elm$core$String$fromFloat(model.mousePos.b) : model.inputYPos,
						mousePos: position
					});
			default:
				var bool = msg.a;
...
var $author$project$CustomTypes$MouseMove = function (a) {
	return {$: 'MouseMove', a: a};
};
var $author$project$CustomTypes$ShouldDragShape = function (a) {
	return {$: 'ShouldDragShape', a: a};
};
var $elm$svg$Svg$Attributes$class = _VirtualDom_attribute('class');
var $author$project$CustomTypes$CreateShape = {$: 'CreateShape'};
var $author$project$CustomTypes$RemoveShape = {$: 'RemoveShape'};
var $author$project$Components$applyFunction = F2(
	function (msg, textToShow) {
		return A2(
			$elm$html$Html$button,
			_List_fromArray(
				[
...
var $author$project$Components$commandButtons = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('commandButtons')
		]),
	_List_fromArray(
		[
			A2($author$project$Components$applyFunction, $author$project$CustomTypes$EditShape, 'Save'),
			A2($elm$html$Html$br, _List_Nil, _List_Nil),
			A2($author$project$Components$applyFunction, $author$project$CustomTypes$CreateShape, 'New'),
			A2($elm$html$Html$br, _List_Nil, _List_Nil),
			A2($author$project$Components$applyFunction, $author$project$CustomTypes$RemoveShape, 'Remove')
		]));
var $elm$core$String$concat = function (strings) {
	return A2($elm$core$String$join, '', strings);
};
var $author$project$HelperFunctions$convertToCode = function (model) {
	var y = model.inputYPos;
	var x = model.inputXPos;
	var w = model.inputWidth;
	var st = model.inputShapeType;
	var h = model.inputHeight;
	var c = model.inputColor;
	return _Utils_eq(st, $author$project$CustomTypes$Ellipse) ? $elm$core$String$concat(
		_List_fromArray(
			['<ellipse cx=\'', x, '\' cy=\'' + y, '\' rx=\'' + w, '\' ry=\'' + h, '\' fill=\'' + c, '\'/>'])) : (_Utils_eq(st, $author$project$CustomTypes$Rectangle) ? $elm$core$String$concat(
		_List_fromArray(
			['<rect x=\'', x, '\' y=\'' + y, '\' width=\'' + w, '\' height=\'' + h, '\' fill=\'' + c, '\'/>'])) : $elm$core$String$concat(
		_List_fromArray(
			['<line x1=\'', x, '\' y1=\'' + y, '\' x2=\'' + w, '\' y2=\'' + h, '\' stroke=\'' + c, '\'/>'])));
};
...
var $author$project$CustomTypes$SelectShape = function (a) {
	return {$: 'SelectShape', a: a};
};
var $author$project$Components$mouseDownEvent = F2(
	function (shape, model) {
		return $elm$html$Html$Events$onMouseDown(
			_Utils_eq(model.selectedShape, shape.id) ? $author$project$CustomTypes$ShouldDragShape(true) : $author$project$CustomTypes$SelectShape(shape.id));
	});
var $elm$svg$Svg$Attributes$rx = _VirtualDom_attribute('rx');
var $elm$svg$Svg$Attributes$ry = _VirtualDom_attribute('ry');
var $elm$svg$Svg$Attributes$stroke = _VirtualDom_attribute('stroke');
var $elm$svg$Svg$Attributes$strokeWidth = _VirtualDom_attribute('stroke-width');
var $author$project$Components$svgEllipse = F2(
	function (shape, model) {
		return A2(
			$elm$svg$Svg$ellipse,
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$cx(shape.xPos),
					$elm$svg$Svg$Attributes$cy(shape.yPos),
					...
					A2($author$project$Components$mouseDownEvent, shape, model)
				]),
			_List_Nil);
	});
...
var $author$project$Components$svgLine = F2(
	function (shape, model) {
		return A2(
			$elm$svg$Svg$line,
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$x1(shape.xPos),
...
var $author$project$Components$svgRect = F2(
	function (shape, model) {
		return A2(
			$elm$svg$Svg$rect,
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$x(shape.xPos),
					$elm$svg$Svg$Attributes$y(shape.yPos),
...
var $author$project$HelperFunctions$convertToSvg = function (model) {
	return A2(
		$elm$core$List$map,
		function (shape) {
			return _Utils_eq(shape.shapeType, $author$project$CustomTypes$Ellipse) ? A2(
				$elm$svg$Svg$g,
				_List_Nil,
				_List_fromArray(
					[
						A2($author$project$Components$svgEllipse, shape, model)
					])) : (_Utils_eq(shape.shapeType, $author$project$CustomTypes$Rectangle) ? A2(
				$elm$svg$Svg$g,
				_List_Nil,
				_List_fromArray(
					[
						A2($author$project$Components$svgRect, shape, model)
					])) : A2(
				$elm$svg$Svg$g,
				_List_Nil,
				_List_fromArray(
					[
						A2($author$project$Components$svgLine, shape, model)
					])));
		},
		model.svgShapes);
};
...
var $author$project$CustomTypes$InputColor = function (a) {
	return {$: 'InputColor', a: a};
};
...
var $author$project$CustomTypes$InputXPos = function (a) {
	return {$: 'InputXPos', a: a};
};
...
var $author$project$Components$chooseShape = F2(
	function (shapeType, textToShow) {
		return A2(
			$elm$html$Html$button,
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick(
					$author$project$CustomTypes$InputShapeType(shapeType))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(textToShow)
...
var $author$project$Components$propertyInput = F3(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onInput(theInput),
							$elm$html$Html$Attributes$value(theValue)
						]),
					_List_Nil),
					A2($elm$html$Html$br, _List_Nil, _List_Nil)
				]));
	});
var $author$project$Components$propertyInputs = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Components$selectShapeButton = function (shape) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text(shape.name)
			]));
};
var $elm$svg$Svg$svg = $elm$svg$Svg$trustedNode('svg');
var $elm$svg$Svg$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Main$view = function (model) {
	var svgShapes = $author$project$HelperFunctions$convertToSvg(model);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$CustomTypes$ShouldDragShape(false))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						function (event) {
							return $author$project$CustomTypes$MouseMove(event.offsetPos);
						}),
						$elm$html$Html$Events$onMouseUp($author$project$CustomTypes$EditShape)
					]),
				svgShapes),
				A2(
				$elm$html$Html$h3,
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$class('propertiesTitle')
					]),
				_List_fromArray(
					[
						$elm$svg$Svg$text('Properties')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('title'),
						$elm$html$Html$Attributes$class('shapesTitle')
					]),
				_List_fromArray(
					[
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"CustomTypes.Msg","aliases":{"CustomTypes.Position":{"args":[],"type":"( Basics.Float, Basics.Float )"}},"unions":{"CustomTypes.Msg":{"args":[],"tags":{"CreateShape":[],"InputShapeType":["CustomTypes.ShapeType"],"InputXPos":["String.String"],"InputYPos":["String.String"],"InputWidth":["String.String"],"InputHeight":["String.String"],"InputColor":["String.String"],"SelectShape":["Basics.Int"],"RemoveShape":[],"EditShape":[],"InputName":["String.String"],"InputStrokeColor":["String.String"],"InputStrokeWidth":["String.String"],"MouseMove":["CustomTypes.Position"],"ShouldDragShape":["Basics.Bool"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"CustomTypes.ShapeType":{"args":[],"tags":{"Ellipse":[],"Rectangle":[],"Line":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));